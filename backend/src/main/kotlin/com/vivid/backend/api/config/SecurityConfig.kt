...
class SecurityConfig(
    ...
    @Bean
    @Order(2)
    fun securityFilterChain(http: HttpSecurity, @Value("\${spring.security.oauth2.resourceserver.jwt.issuer-uri}") issuerUrl: String?): SecurityFilterChain {
        http
    ...
    private fun jwtAuthenticationConverter(): JwtAuthenticationConverter {
        ...
        converter.setJwtGrantedAuthoritiesConverter { jwt ->
            emptyList() // TODO: Extract roles from JWT
        }
        return converter
    }
}
